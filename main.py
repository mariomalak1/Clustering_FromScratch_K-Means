...
if __name__ == "__main__":
    # clusters, num_iterations, dataAfterClusteringWithModification, outliers, labels = main(r"SS2025_Clustering_SuperMarketCustomers.csv", 100, 2)
    clusters, num_iterations, dataAfterClusteringWithModification, outliers, labels = main(r"SS2025_Clustering_CreditCardData.csv", 20, 3)
